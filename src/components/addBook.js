  ...
  return (
    <div className="m-2 p-4">
      <Card className="col-md-6 col-sm-8 col-xs-8 mx-auto">
        ...
        <Card.Title className="my-2 mx-2" style={{ fontSize: "xx-large" }}>
          Enter Details of the Book
        </Card.Title>
        <Card.Subtitle className="mb-2 mx-3 text-muted ">
          Be Careful While Entering Details!
        </Card.Subtitle>
        <Card.Body>
          <Form
            autoComplete="off"
